...
# -----------------------
# Connect to Supabase Pooler (IPv4, Transaction mode)
# -----------------------
...
if selected == "Home":
    st.markdown("<div class='card'><h2>Welcome to Abia State Education Revolution</h2>"
                "<p>Real-time monitoring of education and health across all 17 LGAs.</p></div>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='card'><h2>Register / Login</h2>"
                "<p>Registration is by invitation only.<br>Contact: bookyade.abia@gmail.com</p></div>", unsafe_allow_html=True)

elif selected == "Request Data":
    st.markdown("<div class='card'><h2>Request Full Dataset</h2>"
                "<p>Fill the form below and the complete Excel file will be emailed to you within 24 hours.</p></div>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='card'><h2>Submit School Data</h2>"
                "<p>Only pre-approved schools can submit. Thank you for helping Abia grow!</p></div>", unsafe_allow_html=True)

elif selected == "Admin Panel":
    st.markdown("<div class='card'><h2>Admin Panel</h2>"
                "<p>Welcome, BookyAde — Creator & System Owner<br>All systems operational ✅</p></div>", unsafe_allow_html=True)

elif selected == "About Creator":
    st.markdown("<div class='card'><h2>Creator: BookyAde</h2>"
                "<p>Final Year Computer Science Student<br>Turned a class project into a real government tool for Abia State.<br><br>"
                "GitHub: github.com/BookyAde<br>Email: bookyade.abia@gmail.com</p></div>", unsafe_allow_html=True)
    st.balloons()
